          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            ...
            <div className='text-justify text-[#a89365]'>
              <p >Apasionado de la tecnologia con dos años de experiencia en el area de redes y conectividad prestando servicios a empresas como Forestal Arauco, Cmpc, Salazar israel entre otros <br/><br/>
                Mi enfoque principal es el Frontend actualmente aprendiendo Back todo en base a frameworks derivados de JS tales como NodeJs, Express entre otros. <br/><br/>
