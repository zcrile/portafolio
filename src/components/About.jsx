...
export const About = () => {
  return (
    <div name='about' className='w-full h-screen bg-[#212934] text-gray-300'>
        ...
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            ...
            <div className='text-justify text-[#a89365]'>
              <p >Apasionado de la tecnologia con dos años de experiencia  <br/><br/>
                Mi enfoque principal es el Frontend actualmente mejorando en Backend todo en base a frameworks derivados de JS tales como NodeJs, Express entre otros. <br/><br/>
